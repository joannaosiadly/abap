...
DATA gv_result TYPE t_char255.
DATA gv_result1 TYPE t_char255.
DATA gt_table TYPE STANDARD TABLE OF zosy_number2.
...
CHANGING cv_result1 TYPE t_char255.

  DATA lt_table TYPE STANDARD TABLE OF zosy_number2.
  ...
  CHANGING gv_result.
    ...
    APPEND gv_result TO gt_table.
    APPEND 'miliardów' TO gt_table.
  ...
  CONCATENATE LINES OF gt_table INTO gv_result1 SEPARATED BY space.
...
FORM inwords
  ...
  CHANGING cv_result TYPE t_char255.
